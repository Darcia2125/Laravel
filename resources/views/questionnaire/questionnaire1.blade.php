...
@section('content')
    ...
    <p>Question1: Integer massa metus, ultrices id ultrices sit amet, sodales vel tellus.Nam turpis orci,feugiat et</p>
        <div class="center">
   ...
   <p>Question2: Integer massa metus, ultrices id ultrices sit amet, sodales vel tellus.Nam turpis orci,feugiat et</p>
    <div class="center">
    ...
    <div class="center">
    <a href="/home" class="btn btn-primary stretched link">Previous </a>
    <a href="/questionnaire2" class="btn btn-primary stretched link">Next </a>
